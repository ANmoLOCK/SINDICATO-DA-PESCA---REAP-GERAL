...
**v1.7.1** — Fix lista Defeso (CPFs do REAP + ID da planilha).
...
**Download pronto:** [SinapescREAP-Windows-v1.7.1.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.1/SinapescREAP-Windows-v1.7.1.zip)
