...
**v1.6.11** — Lote de 50 sócios: janela não fecha no erro; rascunho e colar Nome;CPF.
...
**Download pronto:** [SinapescREAP-Windows-v1.6.11.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.6.11/SinapescREAP-Windows-v1.6.11.zip)
