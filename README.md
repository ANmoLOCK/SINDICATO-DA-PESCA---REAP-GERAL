...
| Versão atual | [**v1.6.5**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.6.5) |
...
## Download do EXE (v1.6.5)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.6.5/SinapescREAP-Windows-v1.6.5.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.6.5

Versão anterior: [v1.6.4](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.6.4) · [v1.6.2](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.6.2)
