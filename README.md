...
- **Privacidade:** removida a Lista pública (site + atalhos na interface web)
- **QR sem link visível:** a prévia e a impressão não exibem mais a URL escrita
...
- Header: logo, e-mail acima dos botões, **← Voltar · ⚙ Configurações · Sair**
- Abas: **Sócios · Pendências · Relatório · Backup · Auditoria · Config.Atalhos**
...
|--------|----------------|-----|
| **v1.6.14** | Lista pública removida + QR sem link visível | [ZIP](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.6.14/SinapescREAP-Windows-v1.6.14.zip) |
